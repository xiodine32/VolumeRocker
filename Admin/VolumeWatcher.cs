...
namespace Library
{
    ...
    {
        public event Action<byte> Change;
        ...
        public void Set(byte currentVolume)
        {
        ...
        public byte Get()
        {
            return (byte)GetMasterVolume();
        }

        private static void SetMasterVolume(float newLevel)
        {
            IAudioEndpointVolume masterVol = null;
            try
            {
